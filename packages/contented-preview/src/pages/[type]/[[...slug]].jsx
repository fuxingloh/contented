...
import ContentedHeadings from '../../components/ContentedHeadings';
import ContentedNavigation, { computeContentSections } from '../../components/ContentedNavigation';
import ContentedProse from '../../components/ContentedProse';
import { useMenu } from '../../components/MenuContext';
import { useTheme } from '../../components/ThemeContext';
import { ContentedMermaidInit } from '../../components/ContentedMermaid';
      ...
      <div className="max-w-8xl relative mx-auto flex justify-center px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="sticky top-[3.25rem] -ml-0.5 h-[calc(100vh-3.25rem)] overflow-y-auto py-12">
            <ContentedNavigation sections={sections} className="w-64 pr-8 xl:w-72 xl:pr-16" />
          </div>
        </div>
        <div
        ...
        >
          <ContentedMermaidInit />
          <ContentedProse html={content.html} type={content.type} />
        </div>

        <div className="hidden xl:sticky xl:top-[4.5rem] xl:-mr-6 xl:block xl:h-[calc(100vh-4.5rem)] xl:flex-none xl:overflow-y-auto xl:py-16 xl:pr-6">
          <nav aria-labelledby="on-this-page-title" className="w-56">
            <ContentedHeadings headings={content.headings} fields={content.fields} />
          </nav>
        </div>
      </div>
    </>
