...
import { ContentedPipeline, FileContent } from '../ContentedPipeline.js';
import { initProcessor, UnifiedContented } from './UnifiedProcessor.js';

export class MdContentedPipeline extends ContentedPipeline {
  async init() {
